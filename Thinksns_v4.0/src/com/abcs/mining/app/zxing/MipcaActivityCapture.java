package com.abcs.mining.app.zxing;
...
import com.abcs.mining.app.zxing.decoding.CaptureActivityHandler;
import com.abcs.mining.app.zxing.decoding.InactivityTimer;
import com.abcs.mining.app.zxing.decoding.RGBLuminanceSource;
import com.abcs.mining.app.zxing.view.ViewfinderView;
...
public class MipcaActivityCapture extends BaseActivity implements Callback,
	...
	public Result scanningImage(String path) {
		...
		hints.put(DecodeHintType.CHARACTER_SET, "UTF8"); // "oi

		BitmapFactory.Options options = new BitmapFactory.Options();
		options.inJustDecodeBounds = true; // С
		scanBitmap = BitmapFactory.decodeFile(path, options);
		options.inJustDecodeBounds = false; // u^JС
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if(resultString.contains("hqb")&&isRecharge){
