...
import com.abcs.imkfsdk.recordbutton.AudioRecorderButton;
import com.abcs.imkfsdk.utils.FaceConversionUtil;
import com.abcs.imkfsdk.utils.FileUtils;
import com.abcs.imkfsdk.view.ChatListView;
...
//                showSessionFinishDialog();
            ...
            if (msg.what == HANDLER_BREAK_TIP) {
                //断开会话前提示
                Toast.makeText(getApplicationContext(), break_tips, Toast.LENGTH_LONG).show();
            }
    ...
    class KeFuStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (IMChatManager.ROBOT_ACTION.equals(action)) {
                ...
                //人工干预
                Toast.makeText(ChatActivity.this, "接收到人工干预", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(getApplicationContext()
                        , "switch状态是:" + status + ",sessionId 是:" + sessionId, Toast.LENGTH_SHORT).show();
