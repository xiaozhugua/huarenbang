...
public class AdapterMyScore extends AdapterSociaxList {
	...
	public ListData<SociaxItem> refreshNew(int count)
			...
			DataInvalidException{
		ListData<SociaxItem> listData= getApiCredit().getScoreDetail(0, mLimit, httpListener);
		return listData;
	}
	...
	public ListData<SociaxItem> refreshFooter(SociaxItem obj)
			throws VerifyErrorException, ApiException, ListAreEmptyException,
			DataInvalidException {
		ListData<SociaxItem> listData= getApiCredit().getScoreDetail(getMaxid(), mLimit, httpListener);
		return listData;
	}
