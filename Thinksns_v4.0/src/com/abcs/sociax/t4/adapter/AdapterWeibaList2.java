...
import com.abcs.sociax.t4.unit.DynamicInflateForWeiba2;
 ...
 * @version 1.0
 */
public class AdapterWeibaList2 extends AdapterSociaxList {
	...
	public AdapterWeibaList2(FragmentSociax fragment, ListData<SociaxItem> list) {
		super(fragment, list);
		isHideFootToast = true;
	}

	public AdapterWeibaList2(FragmentSociax fragment, ListData<SociaxItem> list, View headerView, ListView listView) {
		super(fragment, list);
		isHideFootToast = true;
	...
	public AdapterWeibaList2(ThinksnsAbscractActivity context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.listitem_weiba2, null);
        ...
        if (weiba.getWeiba_name() != null) {
            DynamicInflateForWeiba2.addWeibaInfo(context, holder.stub_weiba_info, weiba, this);
        } else {
