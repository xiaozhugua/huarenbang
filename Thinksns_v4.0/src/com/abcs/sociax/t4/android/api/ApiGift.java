...
public interface ApiGift {
	String MOD_NAME = "Gift";
	String GIFT_ALL = "gift_all";
	String BUY_GIFT = "exchange";
	String GIFT_MY = "gift_my";
	String GIFT_USER = "user_gift";
	String SEND_GIFT = "send_gift";
	String RESEND_GIFT = "resend_gift";
	
	/******************t4*********************/
	String GET_SHOP_GIFT = "getList";//获取积分商城礼物列表
	String GET_GIFT_DETAIL = "getInfo";//获取礼物详情
	String EXCHANGE_GIFT = "buy";//兑换礼物
	String GET_MY_GIFTS = "getLog";//我的礼物
	String TRANSFER_MY_GIFT = "transfer";//礼物转赠
	/**
	 * 获取所有礼物列表
	 * 
	 * @return
	...
	String getGiftDetail(String id) throws ApiException;
	/**
	 * 兑换礼物
	 * 
	 * @return
	 ...
	 * @throws ExceptionIllegalParameter
	 */
	String exchangeGift(String id, int uid, int num, String addres, String say, String type, String phone, String name) throws ApiException;
	 ...
	 * @throws ApiException
	 */
	String transferMyGift(String logId, int uid, String say, int num, String type) throws ApiException;
}
