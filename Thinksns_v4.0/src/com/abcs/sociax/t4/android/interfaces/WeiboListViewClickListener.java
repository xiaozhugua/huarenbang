...
public interface WeiboListViewClickListener {
     ...
     */
    //对微博点赞
    void onDigWeibo(int position);

    //对微博评论
    void onCommentWeibo(ModelWeibo weibo, ModelComment comment);

    //点击微博更多选项
    void onWeiboMoreClick(int position);

    //刷新微博
    void onRefresh();

    //关注微博好友
    void onFollowWeibo(ModelWeibo weibo);
