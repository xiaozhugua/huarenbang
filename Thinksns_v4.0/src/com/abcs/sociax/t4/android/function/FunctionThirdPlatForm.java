...
//import com.abcs.sociax.t4.android.login.ActivityBindThirdLoginUser;
...
//import com.abcs.sociax.t4.unit.PrefUtils;
...
//        String str_shareTitle = null;// 分享的标题，一般 “来自uname的分享”
//        String str_shareContent = null;// 分享的内容
//        String str_shareUrl = "http://" + configHost[0] + context.getResources().getString(R.string.w3g_address_of_share_erweima) + user.getUserName();
