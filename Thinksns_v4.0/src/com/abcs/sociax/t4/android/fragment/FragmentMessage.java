...
import com.abcs.sociax.t4.adapter.AdapterViewPagerMessage;
...
//	public AdapterViewPager adapter_vp_msg;
	...
	public void initView() {
		activity= (HomeMessageActivity) getActivity();
	...
	public void initFragments(){
		adapter_vp_msg = new AdapterViewPagerMessage(getChildFragmentManager());
	...
	public void setTitleBgUi(RadioButton selected){
		...
		for (int i = 0; i < 2; i++) {
			if (rbtitle[i].getId() != selected.getId()){
				...
				rbtitle[i].setTextColor(getActivity().getResources().getColor(R.color.themeColor));
			}else{
