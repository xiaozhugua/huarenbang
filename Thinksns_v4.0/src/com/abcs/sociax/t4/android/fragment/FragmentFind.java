...
import com.abcs.sociax.t4.adapter.ImageAdapter;
...
import com.abcs.sociax.t4.android.function.FunctionAdvertise;
import com.abcs.sociax.t4.android.gift.ActivityScoreShop;
import com.abcs.sociax.t4.android.info.ActivityInformation;
...
public class FragmentFind extends FragmentSociax {
    ...
    private LinearLayout rl_find_cicle, rl_find_weiba, // 发现--微吧
    ...
    public void initView() {
        ...
        tv_center.setText("华人圈");
        // 发现
        rl_find_topic = (LinearLayout) findViewById(R.id.rl_topic);
        rl_find_cicle = (LinearLayout) findViewById(R.id.rl_cicle);
    ...
    public void initListener() {
        //朋友圈
        rl_find_cicle.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ActivityFindCicle.class);
