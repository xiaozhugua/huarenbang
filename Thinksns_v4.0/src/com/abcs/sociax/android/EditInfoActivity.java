...
public class EditInfoActivity extends ThinksnsAbscractActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		headArrow = (ImageView) findViewById(com.abcs.sociax.android.R.id.img_head_arrow);
		userName = (TextView) findViewById(com.abcs.sociax.android.R.id.user_name);

		userName.setText(getIntentData().getString("uname"));
		RadioGroup radioGroup = (RadioGroup) findViewById(com.abcs.sociax.android.R.id.radio_group);

		userPhone = (TextView) findViewById(com.abcs.sociax.android.R.id.text_edit_phone);
		userInfo = (TextView) findViewById(com.abcs.sociax.android.R.id.text_edit_info);
		...
		headArrow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new AlertDialog.Builder(EditInfoActivity.this)
						.setTitle("选择头像")
						.setItems(com.abcs.sociax.android.R.array.camera, new headImageChangeListener())
						.show();
			}
		});
	...
	public int getRightRes() {
		// TODO Auto-generated method stub
		return com.abcs.sociax.android.R.drawable.menu_send_img;
	}
	...
	public String getTitleCenter() {
		// TODO Auto-generated method stub
		return getString(com.abcs.sociax.android.R.string.edit_info);
	}
	...
	protected int getLayoutId() {
		// TODO Auto-generated method stub
		return com.abcs.sociax.android.R.layout.editinfo;
	}
