...
public interface ApiContact {
	...
	String MOD_NAME = "Contact";

	// 获取所有联系人列表
	String GET_ALL_COLLEAGUE = "get_all_colleague";
	// 获取我的联系人列表
	String GET_MY_CONTACTER = "get_my_contacter";

	// 返回部门列表
	String GET_DEPARTMENT_LIST = "get_department_list";
	/**
	 * 部门下联系人
	 */
	String GET_COLLEAGUE_BY_DEPARTMENT = "get_colleague_by_department";

	String GET_DATA_BY_DEPARTMENT = "get_data_by_department";

	String CONTACTER_CREATE = "contacter_create";

	String CONTACTER_DESTROY = "contacter_destroy";

	String SEARCH_COLLEAGUE = "search_colleague";
