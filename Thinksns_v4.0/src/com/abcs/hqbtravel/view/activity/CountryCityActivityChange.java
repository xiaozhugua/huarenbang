...
import com.abcs.hqbtravel.adapter.CityListAdapter2;
...
public class CountryCityActivityChange extends Activity {
                ...
                public void run() {
                    ...
                    if (city.result==1) {
                        ...
                        if(city.body.data!=null&&city.body.data.size()>0){
                            cityListAdapter2 = new CityListAdapter2(CountryCityActivityChange.this,city.body.data);
