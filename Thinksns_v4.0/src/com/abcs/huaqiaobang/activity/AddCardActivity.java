...
/**
 * @author xbw
 * @version 创建时间：2015年10月23日 下午4:12:17
 */
...
//							});
		...
		findViewById(R.id.acount_step3_txt_protocol).setOnClickListener(
				new OnClickListener() {
		...
		HttpRequest.sendPost(TLUrl.getInstance().URL_bindBank,
				...
				new HttpRevMsg() {
					...
					public void revMsg(final String msg) {
						...
						LogUtil.e("getSecurityCode", msg);// {"msg":{"requestid":"TULINGBANK1445500940702"},"status":1}
						handler.post(new Runnable() {
