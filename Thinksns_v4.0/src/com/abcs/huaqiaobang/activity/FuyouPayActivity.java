...
//                http://huohang.huaqiaobang.com/mobile/api/payment/alipay/call_back_url.php
                if(url.contains("huaqiaobang.com")){
                    MyUpdateUI.sendUpdateCollection(FuyouPayActivity.this, MyUpdateUI.ORDER);
                    MyUpdateUI.sendUpdateCollection(FuyouPayActivity.this,MyUpdateUI.MYORDERNUM);
                    Log.i("zjz","支付成功！");
                    finish();
                ...
                /*fomo支付*/
                if(url.indexOf("http://newapi.tuling.me/japi/epay/fomo_return.html")==0){
                    MyUpdateUI.sendUpdateCollection(FuyouPayActivity.this, MyUpdateUI.ORDER);
                    MyUpdateUI.sendUpdateCollection(FuyouPayActivity.this,MyUpdateUI.MYORDERNUM);
                    showToast("支付成功！");
                    Log.i("zjz","支付成功！");
                    finish();
                }else if(url.indexOf("http://www.tuling.me")==0){
                    showToast("支付失败！");
                    finish();
                }else if(url.indexOf("http://www.baidu.com")==0){
                    showToast("支付失败！");
                    finish();
                }
