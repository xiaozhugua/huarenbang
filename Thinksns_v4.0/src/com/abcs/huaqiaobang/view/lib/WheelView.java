...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable1 == null) {
            centerDrawable1 = getContext().getResources().getDrawable(
                    R.color.tljr_c_red);
        }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // + offset);
        centerDrawable.setBounds(getWidth() / 4, center - offset,
                getWidth() * 3 / 4, center - offset + 5);
        centerDrawable.draw(canvas);
        centerDrawable1.setBounds(getWidth() / 4, center + offset,
                getWidth() * 3 / 4, center + offset + 5);
