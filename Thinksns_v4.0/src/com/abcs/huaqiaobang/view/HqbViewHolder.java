...
public class HqbViewHolder {
    ...
    public HqbViewHolder setText(int viewId, String text,int ishow) {
        TextView view = getView(viewId);
        view.setText(text);
        if(ishow==1){
    ...
    public HqbViewHolder setReLativeVisiBiLity(int viewId,boolean isvisible) {
     ...
     * @return
     */
    public HqbViewHolder setImageByUrl(int viewId, String url,int ishow) {
        ImageView view=getView(viewId);
        ImageLoader.getInstance().displayImage(url,view, Options.getListOptions());
        if(ishow==1){
            view.setVisibility(View.GONE);
        }else {
            view.setVisibility(View.VISIBLE);
