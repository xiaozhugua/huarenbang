 ...
 */package com.abcs.huaqiaobang.ytbt.contact;
...
import com.abcs.huaqiaobang.ytbt.common.utils.BitmapUtil;
import com.abcs.huaqiaobang.ytbt.common.utils.DemoUtils;
import com.abcs.huaqiaobang.ytbt.common.utils.FileAccessor;
import com.abcs.huaqiaobang.ytbt.core.ECArrayLists;
import com.abcs.huaqiaobang.ytbt.core.Phone;
import com.abcs.huaqiaobang.ytbt.core.PyComparator;
import com.abcs.huaqiaobang.ytbt.storage.ContactSqlManager;
import com.abcs.huaqiaobang.ytbt.storage.GroupMemberSqlManager;
...
//        }
    ...
    public static Bitmap getChatroomPhoto(final String groupid) {
        ...
        if(groupid.toUpperCase().startsWith("G")) {
            return BitmapFactory.decodeResource(CCPAppManager.getContext().getResources() , R.drawable.a_5);
        }
        return mDefaultBitmap;
    }
