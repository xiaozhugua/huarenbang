...
import com.abcs.huaqiaobang.ytbt.storage.ConversationSqlManager;
import com.abcs.huaqiaobang.ytbt.storage.GroupNoticeSqlManager;
...
public class ECNotificationManager {
    ...
    public static void showCallingNotification(ECVoIPCallManager.CallType callType) {
        try {
            ...
            Notification notification = new Notification(R.drawable.a_5, null,
            ...
            if(callType == ECVoIPCallManager.CallType.VIDEO) {
             ...
             //   intent = new Intent(Register_Activity.ACTION_VOICE_CALL);
            }
