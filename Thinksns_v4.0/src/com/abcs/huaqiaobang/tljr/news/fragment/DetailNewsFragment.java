...
public class DetailNewsFragment extends Fragment implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = activity.getLayoutInflater().inflate(R.layout.tljr_fragment_hqss_news_details, null);
    ...
    public void addCommentView(ArrayList<Comment> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            v.findViewById(R.id.add_child).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            // 评论点赞
            v.findViewById(R.id.tljr_ly_news_comment_praise).setOnClickListener(new OnClickListener() {
