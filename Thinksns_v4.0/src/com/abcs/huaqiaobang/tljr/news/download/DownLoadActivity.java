...
public void updateProgress(int position,int progress){
	 if(listview !=null){
			...
			if(viewT !=null){
				NumberProgressBar processbar = ViewHolder.get(viewT, R.id.processbar_download);
				processbar.setVisibility(View.VISIBLE);
				processbar.setProgress(progress);
				
				CheckBox btn_tick = ViewHolder.get(viewT, R.id.btn_tick);
