...
public class News extends RealmObject   {
    ...
    private String timeKey;// 时间key，用于向服务器请求 历史 20条数据
    ...
    public String getLetterSpecies() {
        return LetterSpecies;
    }

    public void setLetterSpecies(String letterSpecies) {
        LetterSpecies = letterSpecies;
    }
