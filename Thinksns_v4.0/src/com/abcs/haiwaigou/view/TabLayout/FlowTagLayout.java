...
public class FlowTagLayout extends ViewGroup {
    ...
    OnTagSelectListenerBean mOnTagSelectListener_bean;
...
//              new MarginLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));//这个构造方法所然能使用但是编译器会报错
    ...
    public void setOnTagSelectListenerBean(OnTagSelectListenerBean onTagSelectListener) {
        this.mOnTagSelectListener_bean = onTagSelectListener;
    }
