 ...
 */
public class RechargeUseFragment extends Fragment implements RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh {
    ...
    private void initAllDates() {
        ...
        HttpRequest.sendPost(TLUrl.getInstance().URL_hwg_my_voucher, "&key=" + MyApplication.getInstance().getMykey() + "&voucher_state=2&curpage=" + currentPage,
                new HttpRevMsg() {
                    @Override
