 ...
 */
public class ReturnFragmentAdapter extends RecyclerView.Adapter<ReturnAndRefundFragmentViewHolder> {
    ...
    public ReturnFragmentAdapter(Activity activity, ReturnAndRefundFragmentViewHolder.ItemOnClick itemOnClick) {
    ...
    public void onBindViewHolder(ReturnAndRefundFragmentViewHolder holder, final int position) {
        ...
        switch (item.getRefund_state()){
            case "1":
                if(item.getSeller_state().equals("1")){
                    holder.t_state.setText("待审核");
                    holder.t_request.setText("无");
                }else if(item.getSeller_state().equals("2")){
                    holder.t_state.setText("待审核");
                    holder.t_request.setText("无");
                    if(item.getGoods_state().equals("1")){
                        holder.t_detail.setText("退货");
                    }else if(item.getGoods_state().equals("2")){
                        holder.t_detail.setText("查看");
                    }
                }
                break;
            case "2":
