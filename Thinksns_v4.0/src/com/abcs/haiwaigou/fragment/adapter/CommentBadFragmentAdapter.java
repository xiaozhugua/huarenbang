 ...
 */
public class CommentBadFragmentAdapter extends RecyclerView.Adapter<CommentItemFragmentViewHolder> {
    ...
    public CommentBadFragmentAdapter(Activity activity, CommentItemFragmentViewHolder.ItemOnClick itemOnClick) {
