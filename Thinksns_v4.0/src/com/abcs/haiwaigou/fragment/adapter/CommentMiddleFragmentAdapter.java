 ...
 */
public class CommentMiddleFragmentAdapter extends RecyclerView.Adapter<CommentItemFragmentViewHolder> {
    ...
    public CommentMiddleFragmentAdapter(Activity activity, CommentItemFragmentViewHolder.ItemOnClick itemOnClick) {
