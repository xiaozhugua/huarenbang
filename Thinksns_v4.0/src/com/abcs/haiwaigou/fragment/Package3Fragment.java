 ...
 */
public class Package3Fragment extends BaseFragment {
   ...
   private String express_name;
    ...
    public static Package3Fragment newInstance(String express_name, String shipping_code, String msg) {
        Bundle bundle = new Bundle();
        bundle.putSerializable("msg", msg);
        bundle.putSerializable("express_name", express_name);
        bundle.putSerializable("shipping_code", shipping_code);
        Package3Fragment fragment = new Package3Fragment();
