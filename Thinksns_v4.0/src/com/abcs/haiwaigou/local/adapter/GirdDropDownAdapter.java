...
public class GirdDropDownAdapter extends BaseAdapter {
    ...
    private List<FiletersBean> list;
    ...
    public GirdDropDownAdapter(Context context, List<FiletersBean> list) {
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.text_red));
