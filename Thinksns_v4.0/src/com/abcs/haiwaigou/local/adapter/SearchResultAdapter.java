...
//        this.mCities = mCities;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null){
            view = LayoutInflater.from(mContext).inflate(R.layout.item_local_search_result_listview, parent, false);
        ...
        holder.name.setText(mCities.get(position).getCate_name()+"("+mCities.get(position).getCatename_en()+") — "+mCities.get(position).getCountryCnName());
        return view;
    }
