...
import com.abcs.haiwaigou.local.huohang.view.ItemGoodsFragment;
...
public class ItemRightAdapter extends BaseAdapter{
    ...
    public void setLeftPos(int left_position){  // 记录左边的position
        this.left_position=left_position;
    }
    public ItemRightAdapter(Context mcontext) {
        this.mcontext = mcontext;
        inflater = LayoutInflater.from(mcontext);
    }
    public void setmTextShop(Context mcontext,TextView shopCart,RelativeLayout liner) {
        this.mcontext = mcontext;
    ...
    public ItemGoodsFragment fragment;
    ...
    public void changeShopCart(int buyNum) {
        ...
        if (buyNum > 0) {
            ...
            fragment.imge.setBackground(mActivity.getResources().getDrawable(R.drawable.img_huohang_n_card));
...
//                fragment.rePeisongJie.setBackgroundResource(R.drawable.bg_bottom_psong_jie_no);
    ...
    public void setmActivity(Activity mActivity, ItemGoodsFragment fragment) {
    ...
    //                http://www.huaqiaobang.com/data/upload/shop/store/goods/11/11_05375327290881075.jpg
                ...
                try {
                    if(!TextUtils.isEmpty(MyApplication.getHHStoreCoin())){
                        ...
                        holder.tv_price.setText("€"+data.goodsPrice+" "+data.taxRate);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    //                http://www.huaqiaobang.com/data/upload/shop/store/goods/11/11_05375327290881075.jpg
                                    MyApplication.imageLoader.displayImage(bean_hd.logo,img, Options.getListOptions2());
                                }
                ...
                holder.ivGoodsAdd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (MyApplication.getInstance().getMykey() == null) {
                            ...
                            EventBus.getDefault().post(new ItemLeftCount(left_position,1));  // 表示加1
                            int goodsNum = 0;
    ...
    //                    // TODO:  添加购物车
                ...
                holder.ivGoodsMinus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        EventBus.getDefault().post(new ItemLeftCount(left_position,0));  // 表示减1
